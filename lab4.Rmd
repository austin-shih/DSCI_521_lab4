...
highlight=TRUE will highlight the code in this code chunk after it is
knit
...
1. <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_austinsh/blob/master/521_lab4_Q7.Rmd>
2. <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_austinsh/blob/master/521_lab4_Q7.html>
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_austinsh/blob/master/521_lab4_Q7.pdf>
...
The .md file has rendered in a way that text sections can be viewed and code chunks can be copied on Github. Unlike html which just rendered the raw code on Github or the pdf render which just save an un-editable pdf file, the .md file can be viewed and edited on Github.
