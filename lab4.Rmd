...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_austinsh>
...
<https://github.com/austin-shih/DSCI_521_lab4>
...
```
    ...
    The above option runs the code chunk but only shows the output and not the code itself.
...
```{r Q5 Code Chunk, error = TRUE, echo = TRUE, highlight = TRUE}
g <- "hello world"
h <- 2023
paste(g, h)
```

- error=TRUE will display any error messages from this code chunk\
- echo=TRUE will display the code in this code chunk after it is knit\
- highlight=TRUE will highlight the code in this code chunk after it is knit
...
```
    ...
    Added 'author: Austin Shih' and 'date: Oct. 1, 2023' to YAML header
...
-   .Rmd file link
    <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_austinsh/blob/master/521_lab4_Q7.Rmd>

1.  <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_austinsh/blob/master/521_lab4_Q7.html>
2.  <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_austinsh/blob/master/521_lab4_Q7.pdf>
...
-   .Rmd file link:
    <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_austinsh/blob/master/521_lab4_Q8.Rmd>
-   html link:
    <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_austinsh/blob/master/521_lab4_Q8.html>
...
-   <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_austinsh/blob/master/521_lab4_Q9.md>
-   The .md file has rendered in a way that text sections can be viewed
    and code chunks can be copied on Github. Unlike html which just
    rendered the raw code on Github or the pdf render which just save an
    un-editable pdf file, the .md file can be viewed and edited on
    Github.
...
<https://austin-shih.github.io/DSCI_521_lab4/521_lab4_Q10.html#1>
